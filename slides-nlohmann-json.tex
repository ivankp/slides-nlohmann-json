...
\begin{itemize}
  ...
  \begin{itemize}
    \item \faFileTextO\ \ in the slides links to documentation
  \end{itemize}
...
\pagebreak
% ------------------------------------------------------------------------------
\slidetitle{Getting and setting values}
...
\pagebreak
% ------------------------------------------------------------------------------
\slidetitle{(De)serializing user types}
